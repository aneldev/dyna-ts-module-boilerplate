...
var Person_1 = __webpack_require__(/*! ./person/Person */ "./src/person/Person.ts");
...
__export(__webpack_require__(/*! ./ */ "./src/index.ts")); // export the web browser version, use the `build-node` `release-node`, both output to /dist/web.js
